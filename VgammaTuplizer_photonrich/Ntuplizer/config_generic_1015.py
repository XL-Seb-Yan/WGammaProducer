...
process.TFileService = cms.Service("TFileService",fileName = cms.string('flatTuple_1015.root'))
...
options.inputFiles = '/store/mc/RunIIFall17MiniAODv2/QCD_HT1000to1500_TuneCP5_13TeV-madgraph-pythia8/MINIAODSIM/PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/40000/FEFD945C-8A43-E811-9C76-0CC47A7C346E.root'
...
doAK8softdropReclustering = config["DOAK8RECLUSTERING"]
...
if config["DOAK10TRIMMEDRECLUSTERING"]:	#NOT USED, ATLAS SEQUENCE		       
...
if config["DOAK8PUPPIRECLUSTERING"]: #TRUE FOR DATA AND FALSE FOR MC
...
if config["GETJECFROMDBFILE"]: #NOT USED IN WG
  process.load("CondCore.DBCommon.CondDBCommon_cfi")
  process.jec = cms.ESSource("PoolDBESSource",
                             DBParameters = cms.PSet(messageLevel = cms.untracked.int32(5)),
...
if config["ADDAK8GENJETS"]:
  ...
  process.genJetsAK8.userData.userFloats.src = (cms.InputTag("ak8GenJetsPrunedMass"),
                                                cms.InputTag("ak8GenJetsSoftDropMass"),
                                                cms.InputTag("NjettinessGenAK8:tau1"),
                                                cms.InputTag("NjettinessGenAK8:tau2"),
                                                cms.InputTag("NjettinessGenAK8:tau3")
                                                )
...
if config["UpdateJetCollection"]: #Needed in 80X to get the latest Hbb training, ##NOT USED IN WG
...
## This section serve as the definition of fucntions needed by the following process DOAK8RECLUSTERING
...
if config["DOAK8RECLUSTERING"]:  ##NOT USED IN WG
...
# ###### Recluster MET ##########
if config["DOMETRECLUSTERING"]: ##NOT USED IN WG
...
if config["DOTAUSBOOSTED"]: ##NOT USED IN WG
#  TAUS = "slimmedTaus"
...
#if False: # config["DOMULTIPLETAUMVAVERSIONS"]:
#
#
...
# For new MVA ID !
#if config["DOMULTIPLETAUMVAVERSIONS"]: ##TAU STUFFS

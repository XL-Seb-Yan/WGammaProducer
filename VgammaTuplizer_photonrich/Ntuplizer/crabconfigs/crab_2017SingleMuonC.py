...
config.General.requestName = 'Wgamma94XSingleMuonTuplesPhotonrich_%s_2017C'%"Apr19"
config.General.workArea = 'crab_jobs_2017C_%s'%"Apr19"
...
config.Data.outputDatasetTag = 'Wgamma94XSingleMuonTuplesPhotonrich_%s_2017C'%"Apr19"

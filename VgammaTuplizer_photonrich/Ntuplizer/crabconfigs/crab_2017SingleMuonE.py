...
config.General.requestName = 'Wgamma94XSingleMuonTuplesPhotonrich_%s_2017E'%"Apr19"
config.General.workArea = 'crab_jobs_2017E_%s'%"Apr19"
...
config.Data.outputDatasetTag = 'Wgamma94XSingleMuonTuplesPhotonrich_%s_2017E'%"Apr19"

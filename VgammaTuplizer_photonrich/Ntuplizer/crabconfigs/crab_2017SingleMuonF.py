...
config.General.requestName = 'Wgamma94XSingleMuonTuplesPhotonrich_%s_2017F'%"Apr19"
config.General.workArea = 'crab_jobs_2017F_%s'%"Apr19"
...
config.Data.outputDatasetTag = 'Wgamma94XSingleMuonTuplesPhotonrich_%s_2017F'%"Apr19"

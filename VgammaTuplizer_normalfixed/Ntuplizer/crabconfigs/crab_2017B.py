...
config.General.requestName = 'Wgamma94XSinglePhoton_%s_2017B'%"Jun25"
config.General.workArea = 'crab_jobs_2017B_photon%s'%"Jun25"
...
config.Data.outputDatasetTag = 'Wgamma94XSinglePhoton_%s_2017B'%"Jun25"

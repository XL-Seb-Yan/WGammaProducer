...
process.TFileService = cms.Service("TFileService",fileName = cms.string('flatTuple_muon.root'))
options = VarParsing.VarParsing ('analysis')
options.maxEvents = -1
options.inputFiles = ('/store/data/Run2017B/SingleMuon/MINIAOD/31Mar2018-v1/90000/FC2B7874-F538-E811-9C29-0025905A60A8.root',

...
config.General.requestName = 'Wgamma94XTuples_%s_2017E'%"Jul17"
config.General.workArea = 'crab_jobs_2017E_%s'%"Jul17"
...
config.Data.outputDatasetTag = 'Wgamma94XTuples_%s_2017E'%"Jul17"

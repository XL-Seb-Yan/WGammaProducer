...
config.General.requestName = 'Wgamma94XSingleMuonTuples_%s_2017B'%"Jun17"
config.General.workArea = 'crab_jobs_2017B_%s'%"Jun17"
...
config.Data.outputDatasetTag = 'Wgamma94XSingleMuonTuples_%s_2017B'%"Jun17"
